...
<body>
	...
	<div id = "content">
		<br /><br /><br />
		<div class="alert alert-info"><h3>Dashboard</h3></div> 
		<div>
        <div class="flex-container" style="width:50%;Text-align:center;float:left;">
			<div class="card" style="width: 28rem;">
				...
				<ul class="list-group list-group-flush">
					...
					<li class="list-group-item"> <a href="user.php" class="btn btn-primary">Manage Users</a> </li>
				</ul>
			</div>
		</div>
        <div class="flex-container" style="Text-align:center;Width:50%;float:right">
		  	<div class="card" style="width: 28rem;">
				...
				<ul class="list-group list-group-flush">
					...
					<li class="list-group-item"> <a href="student.php" class="btn btn-primary">Manage Students</a> </li>
				</ul>
			</div>
		</div>
	</div>
