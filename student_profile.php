...
<body>
	...
	<div class="col-md-8">
		<div style="margin-top:100px; margin-bottom:15px; text-align:center; background-color:lightblue; padding:10px; "> <h3> <b>  Files List </b></h3></div>
				...
				<table id="table" class="table table-bordered">
					...
					<tbody>
						...
						<tr class="del_file<?php echo $fetch1['store_id']?>">
							...
							<td><button class="btn btn-danger btn_remove" type="button" id="<?php echo $fetch1['store_id']?>"><span class="glyphicon glyphicon-trash"></span> Remove</button> | <a href="edit_file.php?store_id=<?php echo $fetch1['store_id']?>" class="btn btn-warning">
